...
StudyAddress: >
  ...
  Tampa, FL 33620-5650
Extend: true # true or false - is this an extension?
Compensation: false # has to be either 'true' or 'false'!
Purpose: >
  Nothing. 
# need to add "The purpose of your study is..." prior to the stated purpose!
Conditional: false # if not 'false', then a list of the conditions - only works on conditional template
